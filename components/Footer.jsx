    ...
    <footer className="min-h-36 flex w-full flex-col items-center justify-center	py-4 text-center font-body text-lg text-white md:text-xl ">
      <div className="flex w-full flex-col px-4 md:w-4/5 md:flex-row md:justify-between">
        ...
        <div className="mb-4 text-center">
          <p className="pb-2 font-heading text-xl md:text-2xl">Follow Us:</p>
          <a
            href="https://www.instagram.com/tedxbitsgoa/"
            target="_blank"
          ...
          >
            <svg
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="feather feather-instagram h-6 w-6"
            >
          ...
          <a
            href="https://www.twitter.com/tedxbitsgoa/"
            target="_blank"
            className=" inline-block px-1 text-red-600"
          >
            <svg
