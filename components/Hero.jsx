...
export default function Hero() {
  ...
  "
      ...
      <div className="relative flex h-screen flex-col justify-end pb-12 md:justify-center  lg:my-auto lg:pl-12">
        <h1 className="font-heading text-6xl font-bold  leading-none lg:text-9xl">
          <span className="text-red-600">TEDx</span>BITSGoa
        </h1>
        <p className="font-body mb-4 text-2xl font-medium uppercase leading-none ">
          Ideas worth spreading
        </p>
        <Link
          className=" font-body inline-block w-fit rounded-lg border border-white py-4 px-16 text-xl font-medium uppercase tracking-wide transition duration-200 ease-in-out
